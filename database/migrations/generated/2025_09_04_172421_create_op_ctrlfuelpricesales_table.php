...
return new class extends Migration
{
    ...
    {
        Schema::create('op_ctrlfuelpricesales', function (Blueprint $table) {
            $table->string('SITEID', 5)->nullable();
            $table->dateTime('DATEPROCE');
            $table->string('INVTIDSKU', 20)->nullable();
            $table->float('SLS_PRICESALES');
            $table->string('CURYID', 3)->nullable();
            $table->float('QTYSALES');
            $table->boolean('STATUS');
            $table->float('TOTALPENSALES');
    ...
    {
        Schema::dropIfExists('op_ctrlfuelpricesales');
    }
};
