...
return new class extends Migration
{
    ...
    {
        Schema::create('op_histransfuel', function (Blueprint $table) {
            $table->char('NUMERO', 4)->nullable();
            $table->char('SOLES', 6)->nullable();
            $table->char('PRODUCTO', 2)->nullable();
            $table->char('PRECIO', 5)->nullable();
            $table->char('GALONES', 8)->nullable();
    ...
    {
        Schema::dropIfExists('op_histransfuel');
    }
};
