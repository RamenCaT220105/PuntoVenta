...
return new class extends Migration
{
    ...
    {
        Schema::create('se_screen', function (Blueprint $table) {
            $table->string('SCREENID', 7)->nullable();
            $table->string('MODULEID', 2)->nullable();
            $table->string('SCREENNAME', 40)->nullable();
            $table->char('SCREENTYPE', 1)->nullable();
