...
return new class extends Migration
{
    ...
    {
        Schema::create('op_promotioncard', function (Blueprint $table) {
            $table->char('PROMOTIONCARDID', 20)->nullable();
            $table->string('NAMECLIENT', 40)->nullable();
            $table->char('PASSWORDMAGNETIC', 30)->nullable();
            $table->string('LASTNAME', 40)->nullable();
            $table->char('PROMOTIONCARDTYPE', 2)->nullable();
    ...
    {
        Schema::dropIfExists('op_promotioncard');
    }
};
