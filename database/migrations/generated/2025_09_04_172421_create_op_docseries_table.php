...
return new class extends Migration
{
    ...
    {
        Schema::create('op_docseries', function (Blueprint $table) {
            $table->string('DOCTYPEID', 3)->nullable();
            $table->decimal('NBRSERIES', 3, 0)->nullable();
            $table->string('SITEID', 5)->nullable();
            $table->decimal('NBRDOC', 7, 0)->nullable();
    ...
    {
        Schema::dropIfExists('op_docseries');
    }
};
