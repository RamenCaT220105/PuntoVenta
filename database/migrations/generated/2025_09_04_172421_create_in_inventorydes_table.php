...
return new class extends Migration
{
    ...
    {
        Schema::create('in_inventorydes', function (Blueprint $table) {
            $table->string('INVTIDSKU', 20)->nullable();
            $table->string('INVTIDSKUDES', 20)->nullable();
            $table->tinyInteger('WTSTK2');
    ...
    {
        Schema::dropIfExists('in_inventorydes');
    }
};
