...
return new class extends Migration
{
    ...
    {
        Schema::create('op_custcard', function (Blueprint $table) {
            $table->string('CUSTIDSS', 20)->nullable();
            $table->string('CARDPASSWORD', 60)->nullable();
            $table->dateTime('EXPIREDATE');
            $table->string('DESCRCUSTCARD', 40)->nullable();
    ...
    {
        Schema::dropIfExists('op_custcard');
    }
};
